...
def CloudyDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "CloudyDawn.py"])

def CloudyMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "CloudyMorning.py"])
   
def CloudyNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "CloudyNight.py"])
    
def CloudyNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "CloudyNoon.py"])

def CloudySunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "CloudySunset.py"])
   
def CloudyTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "CloudyTwilight.py"])
    
def HardRainDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "HardRainDawn.py"])

def HardRainMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "HardRainMorning.py"])
   
def HardRainNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "HardRainNight.py"])
    
def HardRainNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "HardRainNoon.py"])

def HardRainSunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "HardRainSunset.py"])
   
def HardRainTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "HardRainTwilight.py"])
    

    
def MidRainDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "MidRainDawn.py"])

def MidRainMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "MidRainMorning.py"])
   
def MidRainNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "MidRainNight.py"])
    
def MidRainNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "MidRainNoon.py"])

def MidRainSunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "MidRainSunset.py"])
   
def MidRainTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "MidRainTwilight.py"])
    
    
def SoftRainDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "SoftRainDawn.py"])

def SoftRainMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "SoftRainMorning.py"])
   
def SoftRainNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "SoftRainNight.py"])
    
def SoftRainNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "SoftRainNoon.py"])

def SoftRainSunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "SoftRainSunset.py"])
   
def SoftRainTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "SoftRainTwilight.py"])
    

def WetCloudyDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "WetCloudyDawn.py"])

def WetCloudyMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "WetCloudyMorning.py"])
   
def WetCloudyNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "WetCloudyNight.py"])
    
def WetCloudyNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "WetCloudyNoon.py"])

def WetCloudySunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "WetCloudySunset.py"])
   
def WetCloudyTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "WetCloudyTwilight.py"])
...
def WetDawn_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "WetDawn.py"])

def WetMorning_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "WetMorning.py"])
   
def WetNight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "WetNight.py"])
    
def WetNoon_script():
    # Run weather_mrng.py
    subprocess.Popen(["python3", "WetNoon.py"])

def WetSunset_script():
    # Run weather_afn.py
    subprocess.Popen(["python3", "WetSunset.py"])
   
def WetTwilight_script():
    # Run weather_rain.py
    subprocess.Popen(["python3", "WetTwilight.py"])
    
    
    
   
  
def weather_mrng_script():
    # Run weather_mrng.py
...
def main(args):
    ...
    if args.weather_mrng:
        weather_mrng_script()
    if args.weather_afn:
        weather_afn_script()
    if args.weather_rain:
        weather_rain_script()
    if args.dynamic_weather:
        dynamic_weather_script()
    if args.building:
        building_script()
    if args.building_remove:
        building_remove_script()
    if args.trafficlight_remove:
    ...
    if args.cloudy_dawn:
        CloudyDawn_script()
    if args.cloudy_morning:
        CloudyMorning_script()
    if args.cloudy_night:
        CloudyNight_script()
    if args.cloudy_noon:
        CloudyNoon_script()
    if args.cloudy_sunset:
        CloudySunset_script()
    if args.cloudy_twilight:
        CloudyTwilight_script() 
        
    if args.hard_rain_dawn:
        HardRainDawn_script()
    if args.hard_rain_morning:
        HardRainMorning_script()
    if args.hard_rain_night:
        HardRainNight_script()
    if args.hard_rain_noon:
        HardRainNoon_script()
    if args.hard_rain_sunset:
        HardRainSunset_script()
    if args.hard_rain_twilight:
        HardRainTwilight_script()
        
    if args.mid_rain_dawn:
        MidRainDawn_script()
    if args.mid_rain_morning:
        MidRainMorning_script()
    if args.mid_rain_night:
        MidRainNight_script()
    if args.mid_rain_noon:
        MidRainNoon_script()
    if args.mid_rain_sunset:
        MidRainSunset_script()
    if args.mid_rain_twilight:
        MidRainTwilight_script()

    if args.soft_rain_dawn:
        SoftRainDawn_script()
    if args.soft_rain_morning:
        SoftRainMorning_script()
    if args.soft_rain_night:
        SoftRainNight_script()
    if args.soft_rain_noon:
        SoftRainNoon_script()
    if args.soft_rain_sunset:
        SoftRainSunset_script()
    if args.soft_rain_twilight:
        SoftRainTwilight_script()
    
    if args.wet_cloudy_dawn:
        WetCloudyDawn_script()
    if args.wet_cloudy_morning:
        WetCloudyMorning_script()
    if args.wet_cloudy_night:
        WetCloudyNight_script()
    if args.wet_cloudy_noon:
        WetCloudyNoon_script()
    if args.wet_cloudy_sunset:
        WetCloudySunset_script()
    if args.wet_cloudy_twilight:
        WetCloudyTwilight_script()
...
if __name__ == '__main__':
    ...
    main_parser.add_argument("--weather_mrng", action='store_true', help="Run weather_mrng.py")
    main_parser.add_argument("--weather_afn", action='store_true', help="Run weather_afn.py")
    main_parser.add_argument("--weather_rain", action='store_true', help="Run weather_rain.py")
    main_parser.add_argument("--dynamic_weather", action='store_true', help="Run dynamic_weather.py")
    main_parser.add_argument("--building", action='store_true', help="Run building.py")
    ...
    main_parser.add_argument("--cloudy_noon", action='store_true', help="Run CloudyNoon_script()")
    main_parser.add_argument("--cloudy_sunset", action='store_true', help="Run CloudySunset_script()")
    main_parser.add_argument("--cloudy_twilight", action='store_true', help="Run CloudyTwilight_script()")
    
    main_parser.add_argument("--hard_rain_dawn", action='store_true', help="Run HardRainDawn_script()")
    main_parser.add_argument("--hard_rain_morning", action='store_true', help="Run HardRainMorning_script()")
    main_parser.add_argument("--hard_rain_night", action='store_true', help="Run HardRainNight_script()")
    main_parser.add_argument("--hard_rain_noon", action='store_true', help="Run HardRainNoon_script()")
    main_parser.add_argument("--hard_rain_sunset", action='store_true', help="Run HardRainSunset_script()")
    main_parser.add_argument("--hard_rain_twilight", action='store_true', help="Run HardRainTwilight_script()")
    
    main_parser.add_argument("--mid_rain_dawn", action='store_true', help="Run MidRainDawn_script()")
    main_parser.add_argument("--mid_rain_morning", action='store_true', help="Run MidRainMorning_script()")
    main_parser.add_argument("--mid_rain_night", action='store_true', help="Run MidRainNight_script()")
    main_parser.add_argument("--mid_rain_noon", action='store_true', help="Run MidRainNoon_script()")
    main_parser.add_argument("--mid_rain_sunset", action='store_true', help="Run MidRainSunset_script()")
    main_parser.add_argument("--mid_rain_twilight", action='store_true', help="Run MidRainTwilight_script()")
    
    main_parser.add_argument("--soft_rain_dawn", action='store_true', help="Run SoftRainDawn_script()")
    main_parser.add_argument("--soft_rain_morning", action='store_true', help="Run SoftRainMorning_script()")
    main_parser.add_argument("--soft_rain_night", action='store_true', help="Run SoftRainNight_script()")
    main_parser.add_argument("--soft_rain_noon", action='store_true', help="Run SoftRainNoon_script()")
    main_parser.add_argument("--soft_rain_sunset", action='store_true', help="Run SoftRainSunset_script()")
    main_parser.add_argument("--soft_rain_twilight", action='store_true', help="Run SoftRainTwilight_script()")
    
    main_parser.add_argument("--wet_cloudy_dawn", action='store_true', help="Run WetCloudyDawn_script()")
    main_parser.add_argument("--wet_cloudy_morning", action='store_true', help="Run WetCloudyMorning_script()")
    main_parser.add_argument("--wet_cloudy_night", action='store_true', help="Run WetCloudyNight_script()")
    main_parser.add_argument("--wet_cloudy_noon", action='store_true', help="Run WetCloudyNoon_script()")
    main_parser.add_argument("--wet_cloudy_sunset", action='store_true', help="Run WetCloudySunset_script()")
    main_parser.add_argument("--wet_cloudy_twilight", action='store_true', help="Run WetCloudyTwilight_script()")
    
    main_parser.add_argument("--wet_dawn", action='store_true', help="Run WetDawn_script()")
    main_parser.add_argument("--wet_morning", action='store_true', help="Run WetMorning_script()")
